...
export default function EthosScene() {
  return (
    <div className="relative h-[260px] w-full overflow-hidden rounded-[1.75rem] border border-white/12 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.16),rgba(255,255,255,0.04)_40%,rgba(18,14,11,0.12)_100%)] md:h-[320px]">
      ...
      <Canvas camera={{ position: [0, 0, 5.5], fov: 34 }} dpr={1} gl={{ antialias: false, powerPreference: 'high-performance' }}>
