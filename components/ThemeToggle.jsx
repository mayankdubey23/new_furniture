...
export default function ThemeToggle({ scrolled = false }) {
  ...
  // During SSR and initial client render, show a neutral loading state
  // that matches neither sun nor moon to avoid hydration mismatch
  if (!isMounted) {
    return (
      <button
        type="button"
      ...
      >
        ...
        {/* Neutral placeholder icon that doesn't commit to light/dark */}
