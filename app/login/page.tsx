    ...
    <main className="relative min-h-screen overflow-hidden bg-transparent px-4 pb-24 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-md">
        ...
        <div className="rounded-[2rem] border border-theme-line/50 bg-white/80 p-8 shadow-[0_25px_80px_rgba(49,30,21,0.12)] backdrop-blur-sm dark:bg-white/5">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div>
                <label htmlFor="signup-password" className={labelClass}>
                  Password <span className="normal-case font-normal tracking-normal text-theme-walnut/40">(min. 6 characters)</span>
                </label>
                <input
                  id="signup-password"
                  type="password"
          ...
          <p className="mt-6 border-t border-theme-line/40 pt-5 text-center text-xs text-theme-walnut/40 dark:text-theme-ivory/30">
            By continuing you agree to Luxe Decor&apos;s{' '}
            <span className="cursor-pointer text-theme-bronze hover:underline">
              Terms of Service
            </span>{' '}
            and{' '}
            <span className="cursor-pointer text-theme-bronze hover:underline">
